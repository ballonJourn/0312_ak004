...
static S_ButtonCallback sButtonCallbackTab[] = {
    ...
    ID_MAIN_sys_home_Button, onButtonClick_sys_home_Button,
...
void mainActivity::onCreate() {
    ...
    mampmTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_ampmTextView);
    ...
    msys_home_ButtonPtr = (ZKButton*)findControlByID(ID_MAIN_sys_home_Button);
